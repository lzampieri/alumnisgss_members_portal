...
function ResItem({ res }) {
    ...
    >
        <div className="w-full flex flew-row gap-2">
            {[...Array(res.depth)].map((e, i) => <div key={i}><FontAwesomeIcon icon={solid('chevron-right')} /></div>)}
            {!!res.archived && <div><FontAwesomeIcon icon={solid('archive')} /></div>}
    ...
    return <div className="main-container-drawer">
        ...
        <Drawer isArchive={true}>
            <div className="flex flex-col w-full items-start">
                ...
                <span>È qui riportata la lista completa di tutte le risorse visibili dall'utente corrente. Quelle contrassegnate dal simbolo <FontAwesomeIcon icon={solid('archive')} /> sono archiviate e generalmente non visibili nel menù laterale.</span>
