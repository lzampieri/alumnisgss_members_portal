...
export default function List() {
    ...
    const columns = [
        ...
        {
            field: 'go', headerName: '', valueGetter: ({ data }) => data.id, cellRenderer: ({ value }) => <Link className="button" href={route('newsletter.edit', { id: value })}><FontAwesomeIcon icon={solid('pen-to-square')} /></Link>,
        }
    ]
