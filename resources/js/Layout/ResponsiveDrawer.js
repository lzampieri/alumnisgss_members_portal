    ...
    return <>
        <div
            className={
                ...
                " lg:relative lg:inset-auto lg:transform-none lg:translate-none lg:opacity-100 lg:w-1/4 lg:h-auto"
            }
        ...
        >
            <div className={
                ...
                " lg:w-full lg:min-h-0 lg:sticky lg:transform-none lg:translate-none lg:h-full " +
                " bg-white p-4"
            }>
                {drawerContent}
            </div>
