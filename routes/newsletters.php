...
Route::prefix('/newsletters')->group( function () {
    ...
    Route::get('/delete/{newsletter}', [ NewsletterController::class, 'delete' ] )->name('newsletter.delete');
    ...
    Route::get('/cronjob', [ NewsletterController::class, 'smtpCallback' ] )->name('newsletter.smtpCallback');
